...
import { Button } from "@/components/ui/button"; // Replace with correct path if alias is not set
import { ScrollArea } from "@/components/ui/scroll-area"; // Replace with correct path if alias is not set
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs"; // Replace with correct path if alias is not set
import { CardContent } from "@/components/ui/card"; // Replace with correct path if alias is not set
import {
  Play,
  Pause,
  Volume2,
...
export default function VideoAnalysisDashboard() {
  ...
  const messages = [
    ...
    {
      Time: 151.04000000000002,

      text: " But it ended up coming out.",
    },
    {
      Time: 152.64000000000001,
    ...
    {
      Time: 196.35999999999999,

      text: " Every day.",
    },
    {
      Time: 197.35999999999999,
      text: " Every single day.",
    },
    {
      Time: 198.35999999999999,
    ...
    {
      Time: 404.52000000000004,
      text: " first want to do is to fight against it.",
    },
    {
      Time: 407.28000000000003,
            ...
            <div className="col-span-2 flex flex-col space-y-6">
              ...
              <div
                className={`bg-[#e0ddd2] rounded-3xl shadow-inner p-4 text-lg font-semibold ${
                  emotionColors[currentEmotion] || "bg-gray-200 text-gray-900"
                }`}
              >
