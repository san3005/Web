...
const messages: Message[] = [
  {
    ...
    time: "0:02",
    text: "Ok, cool. Let's get started. To start, can I ask how long you've been using Zotify for?",
    emotion: {
      type: "Satisfaction",
      confidence: 0.85,
    },
  },
  {
    ...
    avatar: "/placeholder.svg",
    time: "0:45",
    text: "I've been using Zotify for about one year.",
    emotion: {
      type: "Embarrassment",
      confidence: 0.92,
    },
  },
  {
    ...
    avatar: "/placeholder.svg",
    time: "1:12",
    text: "And what made you want to try Zotify specifically?",
    emotion: {
      type: "Interest",
      confidence: 0.88,
    },
...
const summaryPoints = [
  {
    title: "Background on Zotify and Pat Barlow's experience",
    time: "0:10",
    content:
      "Pat Barlow has used Zotify for about one year after seeing good reviews and wanting to try a new music app. Pat Barlow has previously used Spotify and Apple Music but wanted to try something new to enhance his music experience.",
    date: "3 September 2024",
  },
  {
    title: "How Pat Barlow uses Zotify and its key benefits",
    time: "1:14",
    content:
      "Pat Barlow likes that Zotify predicts what he wants to listen to and suggests new music he wouldn't find elsewhere. Pat Barlow uses Zotify to discover new music across different cultures and genres.",
    date: "3 September 2024",
  },
];
...
export default function VideoAnalysisDashboard() {
  ...
  const rewindVideo = (seconds: number) => {
    if (videoRef.current) {
  ...
  return (
    <section className="w-screen py-3 md:py-2 lg:py-2 bg-white flex justify-center">
      <div className="w-full max-w-[96%] lg:max-w-[98%] rounded-3xl flex items-center justify-center mx-auto">
        <motion.div
          className="w-full bg-[#f0efe9] px-8 rounded-3xl p-6 shadow-lg"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="col-span-1 lg:col-span-2 flex flex-col space-y-6">
              ...
              <div className="block lg:hidden mt-6 bg-[#f0efe9]">
                <Tabs defaultValue="summary">
                  <TabsList className="grid w-full grid-cols-2 font-semibold mb-4 text-[#6f6c5d]">
                    <TabsTrigger className="text-[#6f6c5d]" value="summary">
                      Summary
                    </TabsTrigger>
                    ...
                    <ScrollArea className="h-60">
                      <div className="space-y-6">
                        {summaryPoints.map((point, index) => (
                          <motion.div
                            key={index}
                            className="p-4 bg-[#d1cdc2] rounded-3xl"
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                            transition={{ duration: 0.3, delay: index * 0.1 }}
                          >
                            <p className="text-sm text-[#6f6c5d] mb-2">
                              {point.content}
                            </p>
                            <div className="flex items-center justify-between text-xs text-[#6f6c5d]">
                  ...
                  <TabsContent value="transcript">
                    <ScrollArea className="h-60">
                      <div className="space-y-4 px-4 text-[#6f6c5d]">
                        {messages.map((message, index) => (
                          ...
                          >
                            <div className="flex-1 space-y-1">
                              <p className="text-sm text-[#6f6c5d]">
                                {message.text}
                              </p>
                              <div
                                className={`text-xs px-2 py-1 rounded-full inline-block font-semibold ${
                                  emotionColors[message.emotion.type]
                                }`}
                              >
              ...
              {/* Transcript for Large Screens - Below Video */}
              <motion.div className="hidden lg:block bg-[#e0ddd2] rounded-3xl shadow-inner p-4 mt-6">
                <h2 className="text-xl ml-4 font-semibold mb-4 text-[#6f6c5d]">
                  Transcript
                </h2>
                <ScrollArea className="h-60">
                  <div className="space-y-4 px-4 text-[#6f6c5d]">
            ...
            {/* Summary for Large Screens */}
            <motion.div className="hidden lg:block col-span-1 bg-[#e0ddd2] rounded-3xl shadow-inner p-4">
              <h2 className="font-semibold mb-4 ml-4 text-2xl text-[#6f6c5d]">
                Summary
              </h2>
              <ScrollArea className="h-[calc(100vh-20rem)]">
                <div className="space-y-6 rounded-3xl mx-2">
                  {summaryPoints.map((point, index) => (
                    <motion.div
                      key={index}
                      className="p-4 font-semibold rounded-2xl bg-[#d1cdc2]"
                    >
                      <p className="text-sm text-[#6f6c5d] mb-2">
                        {point.content}
                      </p>
...
const emotionColors: Record<string, string> = {
  ...
  Contempt: "bg-yellow-300 text-yellow-900",
  Joy: "bg-green-300 text-green-900",
  Confusion: "bg-blue-300 text-blue-900",
  Concentration: "bg-purple-300 text-purple-900",
  EmpathicPain: "bg-red-300 text-red-900",
  Neutral: "bg-gray-200 text-gray-900",
};

// Sample summaries (replace with your real data)
const summaries = [
  {
    Interval_Start: 0,
    Psychometric_Summary:
      "During the analyzed segment, the individual articulates a complex relationship...",
  },
  {
    Interval_Start: 120,
    Psychometric_Summary:
      "During the analyzed video segment, the individual expresses profound psychological...",
  },
];

// Sample emotions (replace with your real data)
const emotions = [
  { Time: 2.5, Final_Emotion: "Boredom" },
  { Time: 5, Final_Emotion: "Contempt" },
  { Time: 120, Final_Emotion: "Joy" },
  { Time: 180, Final_Emotion: "Confusion" },
];

// Sample transcript messages (replace with your real data)
const messages = [
  {
    speaker: "Cheri March",
    avatar: "/placeholder.svg",
    time: "0:02",
    text: "Ok, cool. Let's get started. To start, can I ask how long you've been using Zotify for?",
    emotion: { type: "Satisfaction", confidence: 0.85 },
  },
  {
    speaker: "Pat Barlow",
    avatar: "/placeholder.svg",
    time: "0:45",
    text: "I've been using Zotify for about one year.",
    emotion: { type: "Embarrassment", confidence: 0.92 },
  },
  {
    speaker: "Cheri March",
    avatar: "/placeholder.svg",
    time: "1:12",
    text: "And what made you want to try Zotify specifically?",
    emotion: { type: "Interest", confidence: 0.88 },
  },
];
...
export default function VideoAnalysisDashboard() {
  ...
  useEffect(() => {
    const findCurrentSummary = () => {
      const summary = summaries
        .slice()
        .reverse()
        .find((s) => currentTime >= s.Interval_Start);
      setCurrentSummary(
  ...
  return (
    <section className="w-screen py-3 bg-white flex justify-center">
      <div className="w-full max-w-6xl flex flex-col mx-auto">
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="col-span-2 flex flex-col space-y-6">
                  ...
                  <div className="relative aspect-video bg-black rounded-2xl">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/80 to-transparent rounded-3xl">
                      <div className="flex items-center text-white">
                        <Button onClick={() => rewindVideo(10)}>
                          <SkipBack />
                        </Button>
                        <Button onClick={togglePlay}>
                          {isPlaying ? <Pause /> : <Play />}
                        </Button>
                        <Button onClick={() => forwardVideo(10)}>
                          <SkipForward />
                        </Button>
              ...
              <div
                className={`bg-[#e0ddd2] rounded-3xl shadow-inner p-4 text-lg font-semibold ${
                  emotionColors[currentEmotion] || "bg-gray-200"
                }`}
              >
            ...
            {/* Summary and Transcript Section */}
            <motion.div className="col-span-1 bg-[#e0ddd2] rounded-3xl shadow-inner p-4">
              <Tabs defaultValue="summary">
                ...
                <TabsContent value="summary">
                  <ScrollArea>
                    <p className="text-[#6f6c5d]">{currentSummary}</p>
                  </ScrollArea>
                </TabsContent>
                <TabsContent value="transcript">
                  <ScrollArea>
                      ...
                      <div key={i} className="mb-2">
                        ...
                        <span
                          className={`inline-block px-2 py-1 rounded-lg text-xs font-semibold ${
                            emotionColors[msg.emotion.type] || "bg-gray-200"
                          }`}
                        >
                          {msg.emotion.type}
                        </span>
