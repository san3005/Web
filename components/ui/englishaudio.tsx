...
const WEBM_URL = "/English.webm"; // Replace with your actual WebM file URL

const WebmAudioAnalysisDashboard = () => {
  ...
  `;
  // Ensure metadata loads on mount
  useEffect(() => {
    const video = videoRef.current;
    if (video) {
      video.load(); // Forces metadata loading
    }
  }, []);
  ...
  // Find current summary based on time
  ...
  // Find current transcript based on time
            ...
            <div className="col-span-2 flex flex-col space-y-6">
              ...
              >
                <video
                  ...
                  preload="metadata"
                />
                <div className="flex items-center text-[#2A6F97] mt-4">
                  <Button
...
export default WebmAudioAnalysisDashboard;
