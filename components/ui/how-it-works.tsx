...
export default function HowItWorks() {
  return (
    <section className="w-full py-0 md:py-2 lg:pt-0 lg:pb-4 bg-white flex justify-center">
          ...
          <div className="mx-auto grid gap-8 sm:grid-cols-1 md:grid-cols-3 md:gap-12 lg:gap-16 items-start pt-8 md:pt-10">
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              ...
              <p className="text-gray-700 text-sm md:text-base">
                Start by uploading a video of the session or interaction. AI
                processes the video to extract emotional cues, behavioral
                patterns, and other psychometric data.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              ...
              <p className="text-gray-700 text-sm md:text-base">
                The AI analyzes the video and generates a detailed report and
                summary on the mental condition and emotional trends observed in
                the patient.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              ...
              <p className="text-gray-700 text-sm md:text-base">
                View a synchronized version of the video with real-time
                emotional markers, showcasing the video alongside tracked
                emotions and other psychological metrics as they happen.
              </p>
            </div>
          </div>
        </div>
